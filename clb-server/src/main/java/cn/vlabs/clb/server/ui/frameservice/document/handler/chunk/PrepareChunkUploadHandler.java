...
public class PrepareChunkUploadHandler extends CLBAbstractAction {

    private static final Logger LOG = Logger.getLogger(PrepareChunkUploadHandler.class);
    ...
    protected Object doAction(Object arg) throws ServiceException {
        try {
            df.checkSystemIOMode("chunkUpload");
            int appid = af.getAppId();
            PrepareChunkUploadParam param = (PrepareChunkUploadParam) arg;
            ChunkResponse res = df.prepareUpload(appid, param);
