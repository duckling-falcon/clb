...
public abstract class CLBAbstractActionWithStream extends ServiceWithInputStream {
    
    protected static Logger log = Logger.getLogger(CLBAbstractActionWithStream.class);
    ...
    protected abstract Object doAction(Object arg, IResource resource) throws ServiceException, BaseException;
