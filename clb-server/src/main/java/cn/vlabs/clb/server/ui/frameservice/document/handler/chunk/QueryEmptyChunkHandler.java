...
public class QueryEmptyChunkHandler extends CLBAbstractAction {

    private static final Logger LOG = Logger.getLogger(QueryEmptyChunkHandler.class);
    ...
    protected Object doAction(Object arg) throws ServiceException, BaseException {
        ...
        Set<Integer> r = df.queryEmptyChunks(appid, (int) arg);
