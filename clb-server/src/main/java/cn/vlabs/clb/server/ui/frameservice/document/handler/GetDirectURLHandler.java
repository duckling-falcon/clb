...
public class GetDirectURLHandler extends CLBAbstractAction {
    
    private static final Logger LOG = Logger.getLogger(GetDirectURLHandler.class);
    ...
    protected Object doAction(Object arg) throws ServiceException {
        try {
            ...
            String docURL = URLBuilder.getDocURL(dv.getStorageKey(), dv.getFileExtension());
            LOG.debug("Direct_URL["+dv.toBriefString()+"] : "+docURL);
            return docURL;
